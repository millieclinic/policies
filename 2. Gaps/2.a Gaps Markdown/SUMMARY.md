...
| SIG Lite 2025 | O. Environmental, Social and Governance (ESG) | N/A | 12 of 14 ESG rows not in scope for a 30-person women's-health clinic. O.4 (hazardous-substance handling) and O.9 (Health & Safety policy) are now Partial — the Medical Waste Management Plan documents biohazardous-waste handling and codifies a workplace-health-and-safety commitment for clinical operations. | Answer "not formally documented — not applicable to Millie's scope" for the other 12; cite Medical Waste Management Plan for O.4 and O.9 |
